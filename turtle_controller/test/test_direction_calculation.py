...
def test_when_calculate_velocity_theta_in_with_delta_x_zero_then_returns_pi_divide_by_2():
    currect_x = 0.0
    currect_y = 0.0
    target_x = 0.0
    target_y = math.sqrt(3)
...
def test_when_calculate_velocity_theta_with_delta_y_equals_zero_and_delta_x_zero_then_return_pi_divide_by_2():
    currect_x = 0.0
    currect_y = 0.0
    target_x = 0.0
    target_y = 0.0
